...
import io.github.forgestove.bottle_ship.config.NbtType;
...
public final class CategoryConfigNode<C> implements ConfigNode<C> {
	public static final Component MULTIPLE_ERRORS = Component.translatable("bottle_ship.config.validator.multiple_errors");
	private String name;
