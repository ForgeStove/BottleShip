package io.github.forgestove.bottle_ship.config.gui;
import io.github.forgestove.bottle_ship.config.tree.RootConfigNode;
...
public final class ConfigScreen<C> extends Screen {
	...
	private static final Component QUIT_UNSAVED_LABEL = Component.translatable("bottle_ship.config.quit.unsaved");
	private static final Component SAVE_LABEL = Component.translatable("bottle_ship.config.save");
	private static final Component CANNOT_SAVE_LABEL = Component.translatable("bottle_ship.config.cannot_save");
	private static final Component QUIT_CONFIRM_LABEL = Component.translatable("bottle_ship.config.quit.confirm");
	private static final Component QUIT_CONFIRM_TITLE = Component.translatable("bottle_ship.config.quit.confirm.title");
	private static final Component QUIT_CONFIRM_WARNING = Component.translatable("bottle_ship.config.quit.confirm.warning");
	private static final Component RESTART_REQUIRED_LABEL = Component.translatable("bottle_ship.config.restart_required");
	private static final Component RESTART_REQUIRED_TITLE = Component.translatable("bottle_ship.config.restart_required.title");
	private static final Component EXIT_MINECRAFT_LABEL = Component.translatable("bottle_ship.config.exit_minecraft");
	private static final Component IGNORE_RESTART_LABEL = Component.translatable("bottle_ship.config.ignore_restart");
