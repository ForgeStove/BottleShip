package io.github.forgestove.bottle_ship.config.gui.entry;
import io.github.forgestove.bottle_ship.config.gui.ConfigCategoryTab;
import io.github.forgestove.bottle_ship.config.tree.ValueConfigNode;
...
public abstract class ValueConfigEntry<C, T, V> extends ConfigEntry {
	public static final Component RESET_BUTTON_LABEL = Component.translatable("bottle_ship.config.reset_to_default.small");
	public static final Component RESET_BUTTON_TOOLTIP = Component.translatable("bottle_ship.config.reset_to_default.full");
	public static final Component UNDO_BUTTON_LABEL = Component.translatable("bottle_ship.config.undo.small");
	public static final Component UNDO_BUTTON_TOOLTIP = Component.translatable("bottle_ship.config.undo.full");
